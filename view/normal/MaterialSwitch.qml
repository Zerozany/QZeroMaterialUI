...
T.Switch {
    ...
    property alias switchIndicator: switchIndicator

    readonly property size iconSize: Qt.size(16, 16)
    readonly property size handleRippleSize: Qt.size(28, 28)
    ...
    indicator: SwitchIndicator {
        ...
        Ripple {
            ...
            width: root.handleRippleSize.width
            height: root.handleRippleSize.height
